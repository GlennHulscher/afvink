...
public class TicTacToe extends JFrame implements ActionListener {
    ...
    private static final String TITEL = "Tic Tac Toe 4 BioInformatica";  //Titel
    ...
    public static void main(String[] args) {
        ...
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage(("C:\\Users\\Glenn\\IdeaProjects\\afvink4\\src\\icon.jpg")));
    ...
    private static void setImages() {
        ...
        leeg = new ImageIcon("C:\\Users\\Glenn\\IdeaProjects\\afvink4\\src\\leeg.jpg");
        kruisje = new ImageIcon("C:\\Users\\Glenn\\IdeaProjects\\afvink4\\src\\kruisje.jpg");
        rondje = new ImageIcon("C:\\Users\\Glenn\\IdeaProjects\\afvink4\\src\\rondje.jpg");
        vraagteken = new ImageIcon("C:\\Users\\Glenn\\IdeaProjects\\afvink4\\src\\question.jpg");
    }
    ...
    */
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (button[0][0].getIcon()!= leeg && button[0][0].getIcon()==button[1][1].getIcon() && button[0][0].getIcon() == button [2][2].getIcon()){
            JOptionPane.showMessageDialog(null, "Je hebt gewonnen!");
            System.exit(0);
        }
        
        if (button[0][2].getIcon()!= leeg && button[0][2].getIcon()==button[1][1].getIcon() && button[0][2].getIcon() == button [2][0].getIcon()){
            JOptionPane.showMessageDialog(null, "Je hebt gewonnen!");
            System.exit(0);
        }
         ...
         * een if structuur om een kruisje danwel een rondje op def
         * button te plaatsen
         */
